      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        {!connected && (
          <div className="bg-amber-950/40 border border-amber-800/25 rounded-sm px-4 py-3 text-xs text-amber-500/80 tracking-wide mb-6">
            ⚠ Connect your wallet to view and unlock your capsules.
          </div>
        )}
        {txSuccess && (
        ...
        {!loading && !error && connected && capsules.length === 0 && (
          <div className="text-center py-20">
            ...
            return (
              <div
                ...
                className={`relative bg-[#111115] border rounded-sm px-8 py-6 shadow-[0_0_40px_rgba(0,0,0,0.5)] transition-all duration-300
                  ${cap.is_unlocked ? "border-emerald-900/30" : "border-amber-900/20"}`}
              >
                ...
                <div className="grid grid-cols-1 gap-3 mb-5">
                  {[
                    ...
                    { label: "Unlock Time", value: new Date(cap.unlock_time * 1000).toLocaleString() },
                    { label: "Index", value: cap.index },
                    { label: "Visibility", value: cap.is_private ? "Private" : "Public" },
